...
export default function QuoteCard({ initialQuote, onNewQuote, isError = false }: QuoteCardProps) {
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center p-8 mx-auto my-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-lg shadow-lg max-w-2xl transition-colors duration-200">
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 mx-auto my-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-lg shadow-lg max-w-2xl transition-colors duration-200">
      <div className="flex flex-col w-full mb-6 text-center">
        <blockquote className="mb-4 text-2xl font-semibold italic text-gray-800 dark:text-gray-100">
        ...
        <cite className="text-right text-lg text-gray-600 dark:text-gray-300 not-italic">
          - {initialQuote.author}
        </cite>
      </div>
