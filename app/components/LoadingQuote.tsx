...
export default function LoadingQuote() {
  return (
    <div className="flex flex-col items-center justify-center p-8 mx-auto my-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-2xl animate-pulse transition-colors duration-200">
